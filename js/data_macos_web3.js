...
Object.assign(NODES, {
  ...
  "web3_smart_contracts": {
    ...
    commands: [
      ...
      { label: "Slither mutation testing", label_en: "Slither mutation testing", cmd: "slither-mutate ./src/contracts --test-cmd='forge test'\nslither-mutate --list-mutators\n# Résultats dans ./mutation_campaign/\n# UNCAUGHT = test manquant pour ce comportement", cmd_en: "slither-mutate ./src/contracts --test-cmd='forge test'\nslither-mutate --list-mutators\n# Results in ./mutation_campaign/\n# UNCAUGHT = missing test for this behavior" },
